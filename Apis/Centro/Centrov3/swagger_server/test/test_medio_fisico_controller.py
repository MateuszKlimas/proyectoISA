...
class TestMedioFisicoController(BaseTestCase):
    ...
    def test_medio_fisico_cod_medio_get(self):
        """
        Test case for medio_fisico_cod_medio_get

        Obtienes una asignatura a partir de su código
        """
        response = self.client.open('/Facultad/MedioFisico/{codMedio}'.format(codMedio=56),
                                    method='GET',
