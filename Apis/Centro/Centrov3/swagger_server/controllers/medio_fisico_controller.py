...
def medio_fisico_id_centro_get(idCentro):
    ...
    # execute our Query
    aux = idCentro
    query = "SELECT \"id_medio\", \"nombreMedioFisico\", \"tipoMedioFisico\", \"precioMedioFisico\", \"capacidadMedioFisico\", \"id_centro\" FROM \"medioFisico\" WHERE \"medioFisico\".id_centro = " + str(idCentro) + " ORDER BY id_centro DESC;"
