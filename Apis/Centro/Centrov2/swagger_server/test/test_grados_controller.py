...
class TestGradosController(BaseTestCase):
    ...
    def test_get_grados(self):
        ...
        query_string = [('tamanoPagina', 56),
                        ('numeroPaginas', 56)]
        response = self.client.open('/Facultad/grado',
                                    method='GET',
    ...
    def test_grado_cod_grado_get(self):
        ...
        """
        response = self.client.open('/Facultad/grado/{codGrado}'.format(codGrado=56),
                                    method='GET',
