...
class NominaContable(Model):
    ...
    """
    def __init__(self, id_nominda_contable: int=None, fecha_pago_nomina: str=None, importe_nomina_contable: int=None, pago_nomina_contable_realizado: bool=None, id_departamento_contable: int=None, id_contable: int=None):
        """
        ...
        :param fecha_pago_nomina: The fecha_pago_nomina of this NominaContable.
        :type fecha_pago_nomina: str
        ...
        self.attribute_map = {
            ...
            'fecha_pago_nomina': 'fechaPagoNomina',
        ...
        self._fecha_pago_nomina = fecha_pago_nomina
    ...
    @property
    def fecha_pago_nomina(self) -> str:
        """
        Gets the fecha_pago_nomina of this NominaContable.

        :return: The fecha_pago_nomina of this NominaContable.
        :rtype: str
        """
        return self._fecha_pago_nomina

    @fecha_pago_nomina.setter
    def fecha_pago_nomina(self, fecha_pago_nomina: str):
        """
        Sets the fecha_pago_nomina of this NominaContable.
